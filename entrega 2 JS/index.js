...
// //Utilizando métodos de array e iterando sobre el array de pizzas, realizar las siguientes actividades,
// // imprimiendo en consola:

// a- Las pizzas que tengan un id impar.

const filtrarImpares= pizzas.filter(pizza => pizza.id % 2 != 0);
...
pizzasBaratas.forEach(pizza =>{
  console.log(`Si. La ${pizza.nombre} tiene un valor de: ${pizza.precio}`)
})
